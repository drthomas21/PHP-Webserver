...
class FourOhThreeController extends \Framework\Controller\BaseController {
	...
	protected function defaultResp(\Framework\Model\Inet\Request\Request $Request) {
		$this->app->setData(json_encode(array("class"=>__CLASS__,"message"=>"This is a sample 403")));
	}
}
